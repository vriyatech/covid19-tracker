(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@nivo/core'), require('@nivo/axes'), require('d3-shape'), require('@nivo/colors'), require('@nivo/tooltip'), require('d3-scale'), require('prop-types'), require('react-motion'), require('lodash/sortBy')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', '@nivo/core', '@nivo/axes', 'd3-shape', '@nivo/colors', '@nivo/tooltip', 'd3-scale', 'prop-types', 'react-motion', 'lodash/sortBy'], factory) :
    (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.nivo, global.nivo, global.d3, global.nivo, global.nivo, global.d3, global.PropTypes, global.ReactMotion, global['lodash/sortBy']));
}(this, (function (exports, React, core, axes, d3Shape, colors, tooltip, d3Scale, PropTypes, reactMotion, sortBy) { 'use strict';
    ...
    var useSeriesLabels = function useSeriesLabels(_ref5) {
      ...
      var theme = core.useTheme();
      var getColor = colors.useInheritedColor(color, theme);
      return React.useMemo(function () {
        var textAnchor;
        var signedPadding;
        if (position === 'start') {
    ...
    var commonPropTypes = {
      ...
      startLabelTextColor: colors.inheritedColorPropType.isRequired,
      ...
      endLabelTextColor: colors.inheritedColorPropType.isRequired,
      ...
      pointColor: colors.inheritedColorPropType.isRequired,
      ...
      pointBorderColor: colors.inheritedColorPropType.isRequired,
