(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-motion'), require('lodash/pick'), require('@nivo/core'), require('@nivo/colors'), require('d3-hierarchy'), require('recompose/compose'), require('recompose/defaultProps'), require('recompose/withPropsOnChange'), require('recompose/withStateHandlers'), require('recompose/pure'), require('prop-types'), require('@nivo/tooltip')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-motion', 'lodash/pick', '@nivo/core', '@nivo/colors', 'd3-hierarchy', 'recompose/compose', 'recompose/defaultProps', 'recompose/withPropsOnChange', 'recompose/withStateHandlers', 'recompose/pure', 'prop-types', '@nivo/tooltip'], factory) :
    (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.ReactMotion, global['lodash/pick'], global.nivo, global.nivo, global.d3, global.RecomposeCompose, global.RecomposeDefaultProps, global.RecomposeWithPropsOnChange, global.RecomposeWithStateHandlers, global.RecomposePure, global.PropTypes, global.nivo));
}(this, (function (exports, React, reactMotion, pick, core, colors, d3Hierarchy, compose, defaultProps, withPropsOnChange, withStateHandlers, pure, PropTypes, tooltip) { 'use strict';
